...
const Footer = () => {
  ...
  const handleResumeDownload = () => {
    ...
    link.href = './assets/AmineFerjaoui_CV.pdf'; // Replace with your actual resume path
    link.download = 'AmineFerjaoui_CV.pdf'; // The downloaded file will be named "Resume-of-Ghayth-Khezami.pdf"
    link.click();
  };
